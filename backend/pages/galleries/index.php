...
if (!empty($keyword)) {
    $qGalleries .= " WHERE description LIKE '%$keyword%' OR author LIKE '%$keyword%'";
}
$qGalleries .= " ORDER BY id DESC";
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-header d-flex align-items-center justify-content-between"
                        ...
                        <h5 class="mb-0">Tabel Galeri</h5>

                            <a href="create.php" class="btn btn-primary">Tambah</a>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="galleryTable" class="table table-bordered table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?= !empty($item->author) ? htmlspecialchars($item->author) : '<span class="text-muted">Tidak ada penulis</span>' ?></td>
                                                <td><?= strlen($item->description) > 100 ? substr($item->description, 0, 100) . '...' : $item->description ?></td>
                                                <td class="text-center">
                                                    ...
                                                    <?php if (isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'admin'): ?>
                                                        <a href="../../actions/galleries/destroy.php?id=<?= $item->id ?>"
