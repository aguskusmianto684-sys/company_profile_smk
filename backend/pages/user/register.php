            ...
            <form action="../../actions/auth/register_proses.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="nameInput" name="name" placeholder="Enter username" required />
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-primary w-100 mt-3">
                    <i class="bi bi-box-arrow-in-right me-1"></i>Registerasi
                </button>
            </form>
            <p class="text-center mt-3">Sudah punya akun? <a href="login.php"><u>Log in di sini</u></a></p>
        </div>
    </div>
