...
if (!empty($keyword)) {
    $qBlog .= " WHERE image LIKE '%$keyword%' 
                   OR title LIKE '%$keyword%'
                   OR author LIKE '%$keyword%'
                   OR content LIKE '%$keyword%'";
}
$qBlog .= " ORDER BY id DESC";
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="fw-bold text-uppercase"><?= $item->title ?: '-' ?></td>
                                                <td class="text-uppercase"><?= $item->author ?: '-' ?></td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <?php if (isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'admin'): ?>
                                                        <a href="../../actions/blogs/destroy.php?id=<?= $item->id ?>"
